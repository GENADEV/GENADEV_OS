...
#define MB_TAG_SET_PHYSICAL_DISPLAY_WIDTH_HEIGHT	0x48003
#define MB_TAG_SET_VIRTUAL_BUFFER_WIDHT_HEIGHT		0x48004
#define MB_TAG_SET_VIRTUAL_OFFSET					0x48009
#define MB_TAG_SET_DEPTH							0x48005	
#define MB_TAG_SET_PIXEL_ORDER						0x48006
